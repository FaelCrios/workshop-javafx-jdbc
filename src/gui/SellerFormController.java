...
public class SellerFormController implements Initializable {
	...
	private Seller getFormData() {
		...
		// Transformando uam data DatePicker que tem zone para uma qualquer
	...
	private void setErrorMessages(Map<String, String> error) {
		...
		//Operador ternario: Ou seja
		//Se tiver a minha condicao for verdadeira eu coloco      V
		//Caso ela for falsa eu coloco                                       V
